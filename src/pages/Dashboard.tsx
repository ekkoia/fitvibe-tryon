  ...
  return (
    <div className="space-y-6 animate-fade-in">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-3">
        {metrics.map((metric, index) => {
          ...
          return (
            <div 
              key={metric.label} 
              className="metric-card group hover:border-primary/30 transition-all duration-300 !p-4"
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
            ...
            {recentActivity.map((activity) => (
              ...
              >
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-sm font-semibold text-foreground">Lead {activity.id}</p>
        ...
        {/* Upgrade Card */}
        <div className="bg-primary rounded-xl p-5 flex flex-col justify-between glow-lime">
          <div>
            <div className="w-10 h-10 rounded-lg bg-primary-foreground/10 flex items-center justify-center mb-3">
              <BarChart3 className="w-5 h-5 text-primary-foreground" />
            </div>
            <h3 className="text-lg title-display text-primary-foreground mb-1">
              ESCALA GLOBAL
            </h3>
          ...
          <button className="mt-4 w-full bg-primary-foreground text-primary text-sm font-semibold py-2.5 rounded-lg hover:bg-primary-foreground/90 transition-colors">
            UPGRADE PRO
          </button>
        </div>
      </div>
